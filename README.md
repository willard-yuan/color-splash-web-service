...
I am a big fan of [Jekyll](http://jekyllrb.com) and I use it for my blog. I used to write
a lot about programming, therefore I often needed to add a code snippets in my posts.
